    ...
    <TouchableOpacity onPress={handleCheckbox} className={`border-[2px] border-white ${isChecked && "border-main"}  bg-white rounded-[6px] px-[10px] py-[10px] flex-row justify-between items-center mt-[10px]`} >
      <View className="flex-row gap-5 items-center">
        ...
        <View>
            ...
            <Text className={`mt-[3px] text-secondary text-[11px] ${isChecked && "line-through"}`}>Sabah 08:00 da yürüyüşe çık</Text>
        </View>
      </View>
      <View>
      <Checkbox className="rounded-[10px]" value={isChecked} onValueChange={setChecked} color={isChecked && '#3B5BDB'  }/>
      </View>
    </TouchableOpacity>
  )
}
